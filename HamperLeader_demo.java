...
public class HamperLeader_demo{
  ...
  public static void main(String[] args){
    ...
    System.out.println("\n");
    System.out.println("This demo will demonstrate the HamperLeader class. "
    + "\n" + "The first player will be HamperLeader "
    ...
    players[0] = new test( Arrays.copyOfRange(deck, 0, 5) );
    System.out.println("HamperLeader's hand : " + Arrays.toString( Arrays.copyOfRange(deck, 0, 5)));
    System.out.println("\n");
