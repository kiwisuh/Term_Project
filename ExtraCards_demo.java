...
public class ExtraCards_demo{
  ...
  public static void main(String[] args){
    ...
    System.out.println("\n");
    System.out.println("This demo will demonstrate the ExtraCards class. "
    + "\n" + "The first player will be ExtraCards "
    + "\n" + "and the next player will be a random player with one card left. "
    + "\n" + "Because of the behaviour of ExtraCards player, if theres no power card"
    ...
    System.out.println("\n");
    players[1] = new RandomPlayer( Arrays.copyOfRange(deck, 5, 6) );
    System.out.println("Next Player's hand : " + Arrays.toString( Arrays.copyOfRange(deck, 5, 6)));
    /* END MIND THE EIGHTS */
    ...
    System.out.println("discard pile after ExtraCards's first play: " + discardPile.top() );
