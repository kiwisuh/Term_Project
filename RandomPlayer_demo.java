...
public class RandomPlayer_demo{
  ...
  public static void main(String[] args){
    ...
    System.out.println("\n");
    System.out.println("This demo will demonstrate the RandomPlayer class. "
    + "\n" + "The first player will be RandomPlayer "
    + "\n" + "and the next player will be a BadPlayer. "
    + "\n" + "RandomPlayer will look at the top of the discard pile"
    + "\n" + "and discard a random valid card");
    System.out.println("\n");

    /* START MIND THE EIGHTS */
    players[0] = new RandomPlayer( Arrays.copyOfRange(deck, 0, 5) );
    System.out.println("RandomPlayer's hand : " + Arrays.toString( Arrays.copyOfRange(deck, 0, 5)));
    System.out.println("\n");
    ...
    System.out.println("discard pile after RandomPlayer's first play: " + discardPile.top() );
